    ...
    <>
      <div>
          ...
          <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
            <div className="grid md:grid-cols-2 flex-row justify-center">
              <div className="col-span-1">
                {" "}
                <h2 className="mb-8 lg:mb-8 md:text-5xl text-5xl font-bold tracking-tight leading-tight text-gray-900 dark:text-white">
                  Our Vision
                </h2>
              </div>
              <div className="col-span-2 lg:ml-9">
                <p className="mb-8 text-lg font-normal text-gray-800 lg:text-2xl sm:px-16 xl:px-1 dark:text-gray-400">
                  Man kind has one ability that separates it from all other
                  species: our ability to create. Our vision is to be a guiding
                  post for those who seek to create and leave the world a better
        ...
        <section background-color="white" className="bg-white dark:bg-gray-900">
          <div
            className="relative border border-gray-80 rounded-xl shadow dark:bg-gray-800 dark:border-gray-700 h-[380px] p-4"
            style={{
              backgroundImage: `url(/our-vision.jpeg)`,
        ...
        <section className="bg-white dark:bg-gray-900">
          <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
            <div className="grid md:grid-cols-2 flex-row justify-center">
              ...
              <div className="col-span-2 lg:ml-9">
                <p className="mb-8 text-lg font-normal text-gray-800 lg:text-2xl sm:px-16 xl:px-1 dark:text-gray-400">
                  To help 300 founders and entrepreneurs bring their ideas to
                  life by 2027.
                </p>
              </div>
            </div>
        ...
        <section className="bg-white dark:bg-gray-900">
          <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
            <h2 className="max-w-2xl lg:mb-8 mb-4 text-4xl font-normal tracking-tight leading-none md:text-5xl text-gray-900 dark:text-white">
              Our Values
            </h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-10 items-center justify-center">
              <div
                className="h-[206px] text-center"
                style={{
              ...
              >
                ...
                <p className="text-lg font-normal text-teal-500 lg:text-2xl sm:px-16 xl:px-1 pt-7 dark:text-gray-400">
                  Integrity
                </p>
              </div>
              <div
              ...
              >
                ...
                <p className="text-lg font-normal pt-7 text-teal-500 lg:text-2xl sm:px-16 xl:px-1 dark:text-gray-400">
                  Transparency
                </p>
              </div>
            </div>
          ...
          <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
            ...
            <div className="grid md:grid-cols-3 gap-10 items-center justify-center cursor-pointer">
              {teamMembersData.map((team) => (
                <div
                  className="keen-slider__slide  max-w-80 pt-4"
                  key={team.id}
