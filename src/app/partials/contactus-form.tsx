            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 lg:py-4 max-w-screen-md">
                    <form action="#" className="space-y-8">
                        ...
                        <div>
                            <label for="subject" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Phone</label>
                        ...
                        <div className="sm:col-span-2">
                            <label for="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Tell us more about your project</label>
