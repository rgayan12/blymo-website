          ...
          <div className="py-2 px-4 mx-auto max-w-screen-lg lg:py-4 w-full">
            <div className="grid md:grid-cols-3 items-start justify-between gap-5">
              <div className="w-full">
                <h3 className="text-2xl font-medium text-[#31AFA9] dark:text-gray-500 md:text-4xl py-4 truncate">
                  Data Extraction
                </h3>
                <p className="font-medium text-gray-700 dark:text-gray-500 text-xl">
          ...
          <div className="py-2 px-4 mx-auto max-w-screen-lg lg:py-4 w-full">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="text-left mt-4 lg:mt-8 text-xl md:text-3xl pr-4">
