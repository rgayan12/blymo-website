    ...
    <div className="bg-slate-950 text-white min-h-screen font-poppins pb-24">
      ...
      >
        ...
        <p className="text-slate-400 max-w-2xl mx-auto mb-8 font-light text-sm md:text-base leading-relaxed">
          Our director previously held positions at the **University of Oxford** and continues to coordinate with academic, health-service, and behavioral advisory specialists to ensure all activities are developmentally and psychologically structured for early-years impact.
        </p>
        <Link href="/about-us">
