            ...
            <div className="justify-center grid grid-cols-1">
              ...
              <div>
                <p className="mb-8 text-lg font-light text-gray-600 lg:text-2xl sm:px-16 xl:px-1 dark:text-gray-400">
                  It is at the hear of what we do. We help solo philanthropists
                  and community projects with limited budgets to spread their
                  message.
                </p>
                <p className="mb-8 text-lg  font-light text-gray-600 lg:text-2xl sm:px-16 xl:px-1 dark:text-gray-400">
                  At BLYMO, we believe in the power of changemakers -
                  individuals and organisations dedicated to making a positive
                  impact in our world. We are here to support outstanding
                  nonprofit organisation, philanthropists, with pro-bono
                  technological solutions provided by our exceptional teams.{" "}
                </p>

                <p className="mb-8 text-lg  font-light text-gray-600 lg:text-2xl sm:px-16 xl:px-1 dark:text-gray-400">
                  Take a look at how we supported Arachchi Foundation, a bold initiative, driven by the vision of Leo
                  Arachchi, a philanthropist and businessman with ties to both
                  Sri Lanka and the UK, is a non-governmental organisation
                  committed to tackling inequality and conflict in Sri Lanka, as
                  well as in the UK and Dubai. Our Services Social media
                  branding Website Design and development Data visualisation
                </p>
            ...
            <figure className="max-w-screen-md mx-auto">
              ...
              <blockquote>
                <p className="text-2xl font-medium text-gray-900 dark:text-white">
                  We're incredibly grateful for the transformative work you've
                  done on our brand. The new branding has exceeded our
                  expectations, propelling our foundation into a fresh, modern
                  direction that we absolutely adore.
                </p>
              </blockquote>
