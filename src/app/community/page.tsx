...
export default async function Community() {
    return (
        <div>
            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-8 lg:px-6">
                    <figure class="max-w-screen-md mx-auto">
                        ...
                        <blockquote>
                            <p class="text-2xl font-medium text-gray-900 dark:text-white">"We're incredibly grateful for the transformative work you've done on our brand. The new branding has exceeded our expectations, propelling our foundation into a fresh, modern direction that we absolutely adore."</p>
                        </blockquote>
                        <figcaption class="flex items-center justify-center mt-6 space-x-3">
                            <Image class="w-20 h-20 rounded-full" width={500} height={400} src="/leo-arachchi.jpg" alt="leo arachchi picture" />
                            <div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                                <div class="pr-3 font-medium text-gray-900 dark:text-white">Leo Arachchi</div>
                                <div class="pl-3 text-sm font-light text-gray-500 dark:text-gray-400">Founder Arachchi Corporation</div>
                            </div>
                        </figcaption>
                    </figure>
                </div>
            ...
            <LetsTalk description="All you have to do is  submit a project, and we will connect you with the expertise and resources you need to amplify your impact." />
