            ...
            <div className="justify-center grid grid-cols-1">
              ...
              <div>
                ...
                <p className="mb-8 text-lg  font-light text-gray-600 lg:text-2xl sm:px-16 xl:px-1 dark:text-gray-400">
                  ...
                  nonprofit organisations, and philanthropists, with pro-bono
                  technological solutions provided by our exceptional teams.{" "}
                </p>

                <p className="mb-8 text-lg  font-light text-gray-600 lg:text-2xl sm:px-16 xl:px-1 dark:text-gray-400">
                  Take a look at how we supported the Arachchi Foundation The
                  Arachchi Foundation, a bold initiative inspired by the vision
                  of philanthropist and real estate investor Leo Arachchi,
                  operates as a non-governmental organization committed to
                  addressing inequality and conflict. With strong connections to
                  Sri Lanka, the UK, and Dubai, the Foundation is dedicated to
                  creating positive change in these regions.
                </p>
        ...
        <section className="bg-white dark:bg-gray-900">
          <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
            <div className="justify-center grid grid-cols-1">
                ...
                <figure className="max-w-screen-md mx-auto">
                  ...
                  <blockquote>
                    <p className="text-2xl font-medium text-gray-900 dark:text-white">
                      ...
                      creativity invested in this project are evident, and we
                      are truly delighted with the results. Thank you for your
              ...
              <p className="text-2xl font-medium text-gray-900 dark:text-white">All you have to do is  submit a project, and we will connect you with the expertise and resources you need to amplify your impact.</p>
            </div>
          </div>
        </section>
