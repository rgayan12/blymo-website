      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="py-5 px-2 mx-auto text-center max-w-screen-xl lg:py-16 lg:px-8">
          <p className="mb-8 text-lg font-light text-gray-600 lg:text-3xl sm:px-16 xl:px-15 dark:text-gray-400">
            ...
            our ability to create. Our vision is to be a guiding post for those
            who seek to create and leave the world a better place than they
            found it.
          </p>
        </div>
      </section>
        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          ...
          <div className="md:ml-8 lg:col-span-5">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-0 md:text-lg lg:text-xl lg:pt-8 dark:text-gray-400">
              ...
              ingenious developers, and imaginative thinkers. Each member brings
              their unique talents and perspectives, united by a common goal-to
              craft a brighter future.Through our collective efforts, we
          ...
          <div className="">
            <div ref={sliderRef} className="keen-slider">
              {services.map((service) => (
                <div className="keen-slider__slide  max-w-80" key={service.id}>
                  <HomePageServiceCard
                    title={service.name}
          ...
          <div className="grid md:grid-cols-3">
            <div className="item mt-10 lg:mt-0">
              ...
              <div className="text-gray-400 mt-3 w-[300px]">
                ...
                <div></div>
                <p className="mt-1">
                  In this stage, we dive deep into thorough research, engage in
                  spirited brainstorming sessions, and carefully craft a
          ...
          <div className="grid md:grid-cols-3 lg:mt-5">
            ...
            <div className="item   mt-10 lg:mt-10]">
              ...
              <div className="text-gray-400 mt-3 w-[300px]">
                ...
                <div></div>
                <p className="mt-1">
                  Post-deployment, we conduct a comprehensive project review to
                  gather feedback, evaluate success, and anticipate future
